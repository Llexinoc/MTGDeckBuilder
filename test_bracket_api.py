...
deck = response.json()
print(f'Commander: {deck.get("commander", {}).get("name", "N/A")}')
print(f'Total cards: {len(deck.get("all_cards", []))}')
print(f'Bracket: {deck.get("bracket", "N/A")}')
print(f'Bracket explanation: {deck.get("bracket_explanation", "N/A")}')
print(f'Game changers: {deck.get("game_changer_count", 0)}')
